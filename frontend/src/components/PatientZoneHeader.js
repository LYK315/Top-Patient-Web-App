...
import { Paper, Stack, Link, AppBar, ListItemIcon, ListItemText, IconButton, Box, Menu, MenuItem, CssBaseline } from "@mui/material";
    ...
    return (
      <Paper elevation={0}>
        ...
        >
          ...
          >
            {/* TPT Logo */}
            <Link href="/patient-zone/patientDashboard" mt={'auto'}>
              <img
            ...
            >
              ...
              <StyledLink
                underline='none'
                href='/patient-zone/appointments'
                fontSize={'16px'}
                fontWeight={'bold'}
              >
                MY BOOKINGS
              ...
              <IconButton
                ...
                >
                  ...
                  <StyledMenuItem
                    href="/patient-zone/profile"
                    onMouseEnter={() => this.hoverBtnTarget('profile')}
                  ...
                  >
                    <ListItemIcon>
                      <ManageProfileIcon
                        fontSize="small"
                        sx={{
                          color: this.state.hoverTarget === 'profile' ? 'text.hover' : 'text.secondary',
                        }}
                      />
                    </ListItemIcon>
                  ...
                  >
                    <ListItemIcon>
                      <LogoutIcon
                        fontSize="small"
                        sx={{
                          color: this.state.hoverTarget === 'logOut' ? 'text.hover' : 'text.secondary',
                        }}
                      />
                    </ListItemIcon>
